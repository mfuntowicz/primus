...
function(setup_sanitizers)
    if (NOT PRIMUS_ENABLE_SANITIZER)
        return()
    endif ()

    string(TOLOWER "${PRIMUS_ENABLE_SANITIZER}" PRIMUS_ENABLE_SANITIZER_LOWERCASE)
    if (PRIMUS_ENABLE_SANITIZER_LOWERCASE STREQUAL "off")
        return()
    endif ()

    if (PRIMUS_ENABLE_BINDINGS_PYTHON)
        message(FATAL_ERROR "PRIMUS_ENABLE_SANITIZER must be set to OFF when building Python bindings")
        return()
    endif ()

    if (PRIMUS_ENABLE_SANITIZER_LOWERCASE STREQUAL "address")
        ...
        message(FATAL_ERROR "Unknown sanitizer type: ${PRIMUS_ENABLE_SANITIZER}")
    endif ()
endfunction()