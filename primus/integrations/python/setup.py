...
# limitations under the License.
# ==============================================================================
"""This setup.py builds a wheel file assuming that Primus is already built
"""
...
setup(
    ...
    packages=find_namespace_packages(where=os.path.normpath("../../../build/python_packages/primus")),
    package_dir={
        "": os.path.normpath("../../../build/python_packages/primus")},
    package_data={'mlir': ['_mlir_libs/*.so']},
    include_package_data=True,
    distclass=BinaryDistribution,
    description='Large-Language Models Kernel definition IR',
    url='https://github.com/mfuntowicz/primus',
